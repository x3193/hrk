...
sed -i 's/^post_max_size = 8M/post_max_size = 400M/' /app/vendor/heroku/heroku-buildpack-php/conf/php/php.ini
# #sed -i 's/^upload_max_filesize = 2M/upload_max_filesize = 2M/' /app/vendor/heroku/heroku-buildpack-php/conf/php/php.ini
sed -i 's/^max_file_uploads = 20/max_file_uploads = 800/' /app/vendor/heroku/heroku-buildpack-php/conf/php/php.ini
...
sed -i 's/^max_execution_time = 30/max_execution_time = 300000/' /app/vendor/heroku/heroku-buildpack-php/conf/php/php.ini
sed -i 's/^max_input_time = 60/max_input_time = 600000/' /app/vendor/heroku/heroku-buildpack-php/conf/php/php.ini
sed -i 's/^memory_limit = 128M/memory_limit = 400M/' /app/vendor/heroku/heroku-buildpack-php/conf/php/php.ini
